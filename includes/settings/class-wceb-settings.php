...
class WCEB_Settings {
	...
	public function __construct() {
		...
		if ( is_admin() ) {
			...
			add_action( 'easy_booking_save_settings', array($this, 'easy_booking_generate_css'), 10, 1 );
	...
	public function easy_booking_add_option_page() {
		add_menu_page( __('Easy Booking', 'easy_booking'), __('Easy Booking', 'easy_booking'), 'manage_options', 'easy-booking', '', 'dashicons-calendar-alt', 58 );
